...
urlpatterns = [
    ...
    path('api/workspaces/<int:workspace_id>/mail/clear/', views_messaging.workspace_mail_clear, name='workspace_mail_clear'),
    ...
    path('api/workspaces/<int:workspace_id>/chat/clear/', views_messaging.workspace_chat_clear, name='workspace_chat_clear'),
    ...
    path('api/dm/conversations/clear/', views_dm.dm_conversations_clear, name='dm_conversations_clear'),
    ...
    path('api/dm/conversations/<int:conversation_id>/clear/', views_dm.dm_message_clear, name='dm_message_clear'),
